    ...
    public static function scriptFromAscii($string)
    {
        ...
        foreach (self::charIn($string) as $char) {
            ...
            if ($ord >= ord('0') && $ord <= ord('9')) {
                $ret .= ['𝟎', '𝟏', '𝟐', '𝟑', '𝟒', '𝟓', '𝟔', '𝟕', '𝟖', '𝟗'][$ord - ord('0')];
            } elseif ($ord >= ord('a') && $ord <= ord('z')) {
                $ret .= ['𝓪', '𝓫', '𝓬', '𝓭', '𝓮', '𝓯', '𝓰', '𝓱', '𝓲', '𝓳', '𝓴', '𝓵', '𝓶', '𝓷', '𝓸', '𝓹', '𝓺', '𝓻', '𝓼', '𝓽', '𝓾', '𝓿', '𝔀', '𝔁', '𝔂', '𝔃'][$ord - ord('a')];
            } elseif ($ord >= ord('A') && $ord <= ord('Z')) {
                $ret .= ['𝓐', '𝓑', '𝓒', '𝓓', '𝓔', '𝓕', '𝓖', '𝓗', '𝓘', '𝓙', '𝓚', '𝓛', '𝓜', '𝓝', '𝓞', '𝓟', '𝓠', '𝓡', '𝓢', '𝓣', '𝓤', '𝓥', '𝓦', '𝓧', '𝓨', '𝓩'][$ord - ord('A')];
            } elseif ($char == " ") {
                $ret .= " ";
            } else {
                continue;
